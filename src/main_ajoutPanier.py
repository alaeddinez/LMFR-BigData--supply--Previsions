...
from data import LoadSales,LoadPageviews
...
SALES_df = LoadSales('nb_ajout_panier','bq')
df_i = SALES_df.dataframe
df_i = df_i.tail(60)
data = df_i.nb_ajout_panier
data = df_i.nb_ajout_panier.astype(float)
...
data_future["nb_ajout_panier"] = np.NaN
...
OutputTableBQ = "nb_ajout_panier_prev"
...
slack_message = {'text' : 'PREV  nb_ajout_panier UPLOADED! :)'}
